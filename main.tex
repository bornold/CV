...
\cvitem{examinator}{Ulf Assarsson}
...
\cventry{2015}{Utvecklare}{Qualisys AB}{Gothenburg}{}{Projektanställd för  att utveckla en lösning att från motion capture data gå till att driva en männsklig karaktär i realtid, arbetet var en fortsättning på exjobbet. 
\newline
Resultat:
\begin{itemize}
...
\cvitemwithcomment{C\#}{Erfaren}{Utvecklade i C\# inom exjobbet och för Qualisys}
\cvitemwithcomment{Java}{Erfaren}{Java användes under större delen av utbildningen samt hobby projekt}
\cvitemwithcomment{Haskell}{Grundläggande}{Användes som språk för kurser inom funktionell programmering}
\cvitemwithcomment{Python}{Grundläggande}{Använts för hobbyprojekt}
\cvitemwithcomment{JavaScript}{Grundläggande}{För hobbyprojekt och utbildning}
\cvitemwithcomment{Erlang}{Grundläggande}{Använts i utbildning}
\cvitemwithcomment{C}{Grundläggande}{Använts i utbildning}
\cvitemwithcomment{Matlab}{Grundläggande}{Använts i utbildning}
\clearpage
...
\cvdoubleitem{Testing}{NUnit, Junit, QuickCheck}{OS}{Windows, Linux}\cvdoubleitem{Scripting}{bash-scripting, Google Apps Script}{IDEs}{NetBeans, Eclipse, Visual Studios, Android Studio, MonoDevelop}
\cvdoubleitem{Version control} {Git, CVS, SVN}{Enviorments}{Andriod, Unity game engine}
\iffalse
\section{Övrigt}
\cvitem{Sydafrika projekt}{Var på resa i sydafrika}
\cvitem{Andriod application}{Android app at Android market}
\fi
\section{Intressen}
\cvitem{Brädspel}{Perfekta blandningen av problemlösning och socialt umgänge}
\cvitem{SciFi}{Stor konsument av både böcker och filmer}
\cvitem{Agrikultur}{Född och uppvuxen inom lantbruk}
\cvitem{Roligt}{Född och uppvuxen inom lantbruk}
