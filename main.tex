...
\begin{itemize}
  ...
  \end{itemize}
Video av resultatet kan ses på \url{qualisys.com/software/unity/}
}

\cventry{2016-idag}{Developer}{Combitech AB}{Gothenburg}{}
{
...
\cvitemwithcomment{Java}{Erfaren}{Användes under utbildningen, hobbyprojekt samt flera projekt}
...
\cvitemwithcomment{C}{Grundläggande}{Används i utbildning}
\cvitemwithcomment{C++}{Grundläggande}{Används i utbildning}
...
\cvlistitem{\url{github.com/bornold}}
\cvlistitem{\url{qualisys.com/software/unity}}
