...
\begin{itemize}
  ...
  \end{itemize}
Video av resultatet kan ses på 
\newline
\url{qualisys.com/software/unity/}
}

\cventry{2016--idag}{Lead Developer}{Combitech AB}{Gothenburg}{}
{
...
\cvitemwithcomment{C\#}{Mycket erfaren}{Som huvudsakliga proffesionella programmeringsspråk}
...
\cvitem{Agrikultur}{Uppvuxen på gotländsk lantbruk}
...
\begin{cvcolumns}
  ...
  \cvcolumn{Combitech}{ \textbf{Roger Nilsson} \newline +46(0)~733~--~17~50~94 \newline \href{mailto:roger.nilsson@combitech.se}{roger.nilsson@combitech.se} }
\end{cvcolumns}
