...
%\quote{\[ e=\lim_{n \to \infty} \left(1+\frac{1}{n}\right)^n \]}                                 % optional, remove / comment the line if not wanted
...
\cvitemwithcomment{Java}{Erfaren}{Används proffessionellt, under utbildningen samt flera hobbyprojekt}
...
\cvitem{Smarta hem}{I synnerlighet när man får skapa det själv}
